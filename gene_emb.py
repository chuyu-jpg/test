...
def main(argv):
    ...
    #print草稿2
    print("\nprint草稿2.1")
    print("graph_train:", graph_train)
    print("\nprint草稿2.2")
    print("graph_val:", graph_val)
    print("\nprint草稿2.3")
    print("graph_test:", graph_test)
    ...
    with open(FLAGS.input + FLAGS.gg_path, 'rb') as f:
        ...
        #print草稿4
        print("\nprint草稿4")
        print("FLAGS.input + FLAGS.gg_path:", FLAGS.input + FLAGS.gg_path)
        #print草稿5
        print("\nprint草稿5")
        print("gg:", gg)
